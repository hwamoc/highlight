...
VALUES (1, 1, 1, 1, '처음 긋는 하이라이트~~', '2021-01-24 12:10:30');
INSERT INTO highlight(id, user_id, page_id, color_ordinal, text, modified_date)
VALUES (2, 1, 1, 1, '구우우웃 구우우웃', null);
INSERT INTO highlight(id, user_id, page_id, color_ordinal, text, modified_date)
VALUES (3, 1, 1, 2, '꾸르잼잼잼 ^0^', '2021-03-28 14:20:30');

INSERT INTO highlight(id, user_id, page_id, color_ordinal, text, modified_date)
VALUES (4, 2, 2, 1, 'AROUND', null);
INSERT INTO highlight(id, user_id, page_id, color_ordinal, text, modified_date)
VALUES (5, 2, 2, 2, '디자인', '2021-07-30 12:30:20');
INSERT INTO highlight(id, user_id, page_id, color_ordinal, text, modified_date)
